...
use styx_core::proto::{
    ...
    styx_service_client::StyxServiceClient, ClientUpdate, CloseRequest, NewShell, OpenRequest,
};
use styx_core::{rand_alphanumeric, Sid};
use tokio::sync::mpsc;
use tokio::task;
...
impl Controller {
    ...
    /// new TCP handshake.
    async fn connect(origin: &str) -> Result<StyxServiceClient<Channel>, tonic::transport::Error> {
        StyxServiceClient::connect(String::from(origin)).await
    }
